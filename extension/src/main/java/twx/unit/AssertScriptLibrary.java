...
public class AssertScriptLibrary {
    ...
    protected static final Logger _logger = LogUtilities.getInstance().getScriptLogger(AssertScriptLibrary.class);


    public static void assertFail(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        if (args.length > 1) {
            throw new Exception("Invalid number of arguments in assertFail");
        }
        throw new AssertionFailedError(args.length == 0 ? "Fail called" : (String) args[0]);
    }
	...
	public static void assertTrue(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if (args[0] instanceof Boolean) {
            if (!(Boolean) args[0]) {
                throw new AssertionFailedError(args.length == 1 ? "Assertion failed, value should be true" : (String) args[1]);
            }
        } else {
	...
	public static void assertFalse(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if (args[0] instanceof Boolean) {
            if ((Boolean) args[0]) {
                throw new AssertionFailedError(args.length == 1 ? "Assertion failed, value should be false" : (String) args[1]);
            }
        } else {
	...
	public static void assertEquals(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if((op1 == null && op2 != null) || (op1 != null && !op1.equals(op2))) {
            throw new AssertionFailedError(args.length == 2 ? "Assertion failed, values should be equal: " + op1 + " != " + op2 : (String) args[2]);
        }
	}
	...
	public static void assertNotEquals(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if((op1 == null && op2 == null) || (op1 != null && op1.equals(op2))) {
            throw new AssertionFailedError( args.length == 2 ? "Assertion failed, values should not be equal: " + op1 + " == " + op2 : (String) args[2]);
        }
	}
	...
	public static void assertNull(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if (args[0] != null) {
            if (args[0] instanceof org.mozilla.javascript.Undefined) {
                throw new AssertionFailedError("assertNull parameter should be a valid type, is undefined");
            } else {
                throw new AssertionFailedError(args.length == 1 ? "Assertion failed, value should be null: " + args[0]
                        : (String) args[1] + args[0].getClass().getName());
            }
        }
    }

    public static void assertNullOrUndefined(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        if (args.length < 1 || args.length > 2) {
            throw new Exception("Invalid number of arguments in assertNull");
        }
        if (args[0] != null) {
            if (!(args[0] instanceof org.mozilla.javascript.Undefined)) {
                throw new AssertionFailedError( args.length == 1 ? "Assertion failed, value should be null or undefined: " + args[0]
                                : (String) args[1]);
            }
        }
	}
	...
	public static void assertNotNull(Context cx, Scriptable me, Object[] args, Function func) throws Exception {
        ...
        if (args[0] instanceof org.mozilla.javascript.Undefined) {
            throw new AssertionFailedError(args.length == 1 ? "Assertion failed, value should not be undefined"
                    : "Is Undefined: " + (String) args[1]);
        }
        if (args[0] == null) {
            throw new AssertionFailedError(
                    args.length == 1 ? "Assertion failed, value should not be null" : "Is Null: " + (String) args[1]);
        }
    }

    public static void assertThrows(Context cx, Scriptable me, Object[] args, Function func) throws Throwable {
        if (args.length != 2 && args.length != 3) {
            throw new Exception("Invalid number of arguments in assertThrows");
        }
        if (!(args[0] instanceof String)) {
            throw new Exception("The first assertThrows argument must be a string with expected exception");
        }
        ...
        try {
            ...
            _logger.warn("Caught WrappedException inside assertThrows:");
            _logger.warn(we.toString());
            _logger.warn(t.toString());
        }
        catch(Exception ex) {
            _logger.warn("Caught Exception inside assertThrows:");
    ...
    public static Object assertHasPermissions(Context cx, Scriptable me, Object[] args, Function func)
            throws Throwable {
        if (args.length != 2 && args.length != 3) {
        ...
        try {
            ...
            if (t.getMessage() != null && t.getMessage().startsWith("Not authorized for")) {
                throw new AssertionFailedError(args.length == 2
                        ? "Assertion failed, principal " + args[0] + " should have permissions: " + t.getMessage()
                        : (String) args[2]);
            } else {
                throw t;
            }
    ...
    public static void assertHasNoPermissions(Context cx, Scriptable me, Object[] args, Function func)
            throws Throwable {
        if (args.length != 2 && args.length != 3) {
        ...
        if (success) {
            throw new AssertionFailedError(
                    args.length == 2 ? "Assertion failed, principal " + args[0] + " should not have permissions"
                            : (String) args[2]);
        }
    }
}
